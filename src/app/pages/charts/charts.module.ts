...
import { EchartsStreamBarComponent } from './echarts/echarts-stream-events.component';
...
@NgModule({
  ...
  declarations: [...routedComponents, HighchartsChartComponent, ...components],
})
